...
definition(
    name: "Turn on Ceiling Fans when Heating or A/C is on",
    namespace: "aarondrabeck",
    author: "Aaron Drabeck",
    description: "Turns on switches when the operating mode of a thermostat changes.  Helps to mix the air in the house providing for a more even heating or cooling",
